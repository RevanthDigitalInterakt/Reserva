...
- Primeiramente, verifique a versão atual em `Targets > reserva > Identity`, como exemplo **Version 2.25.1** e **Build 2023000200.2.25.1**.

**Obs:** Para substituir o build number (`2023000200.2.25.1`) em todos os arquivos exibidos na sua busca, você pode seguir o mesmo processo.
...
- **Substituir por uma nova versão:** Na caixa de texto logo abaixo da busca, insira a nova versão que você deseja usar, por exemplo, `2.25.1`.
...
**Caminhos onde a versão `2.25.1` precisa ser alterada:**
