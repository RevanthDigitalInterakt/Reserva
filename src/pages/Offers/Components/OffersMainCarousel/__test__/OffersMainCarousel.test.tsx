...
import OffersMainCarousel from '../OffersMainCarousel';

const mockNavigate = jest.fn();

const mockedMainCarousel = {
  id: 'MAIN',
  type: 'MAIN',
  showtime: 10,
  items: [{
...
const Component = (
  <ThemeProvider theme={theme}>
    <OffersMainCarousel data={mockedMainCarousel as OffersCarouselsOutput} />
  </ThemeProvider>
);

describe('OffersMainCarousel', () => {
  beforeEach(async () => {
    render(Component);
  });
