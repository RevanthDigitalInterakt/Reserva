...
export const OrdersAndDeliveries = () => {
    ...
    const data = [
        ...
        },
        {
            ...
            \nEntre em contato com a nossa Central de Atendimento através do e-mail: sac@usereserva.com ou do telefone: 011.2388-8280 - SP e demais estados / 021.2108-4990 – RJ, para que possamos identificar o problema e informar o ocorrido.
            \nSe você ainda estiver com dúvidas, ou precisa falar com o nosso time de encantadores, basta clicar em Central de ajuda e ir na opção "Fale Conosco".
            `,
        },
        {
