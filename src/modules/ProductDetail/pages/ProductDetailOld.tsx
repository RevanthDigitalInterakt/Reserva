...
export const ProductDetailOld: React.FC<Props> = ({
  route,
  navigation,
}) => {
  /**
  ...
  const onProductShare = async (url: string) => {
    ...
    onShare(options.title, options.message, options.url);
  };
            ...
            {product && sellerProduct && (
              <>
                ...
                <ProductDetailCard
                  ...
                  onClickShare={() => onProductShare(product.link)}
                  discountTag={
                    getPercent(
                      sellerProduct.commertialOffer.Price,
