...
import {
  Typography, Box, Button, Icon, Divider, Checkbox, theme,
  ...
  return (
    <SafeAreaView flex={1} backgroundColor="white">
            ...
            ? (
              <>
                <SelectPayment
                  ...
                  onPress={() => navigation.navigate('ListCards', { isCheckout: true, cashback: isCheckedCashback })}
                  divider
                />
                <SelectPayment
                  iconLeft="Pix"
      ...
      {paymentDifference >= 0 && isCheckedCashback
        && (
        <Button
          onPress={() => navigation.navigate('SummaryScreen', { paymentType: 'Cashback' })}
          title="RESUMO"
