                ...
                >
                    ...
                    <Box marginBottom={"xxs"}>
                        <Typography variant={"tituloSessao"}>
                            ...
                            compra e poderá ser efetuado pagamento em qualquer banco pelo Internet Banking.
                        </Typography>
                    </Box>
                    <Information
                        number={"1"}
        ...
        <>
            <Box flexDirection={"row"} >
                <Box
                    ...
                    alignItems={"center"}
                >
                    <Typography fontFamily={"reservaSerifRegular"} fontSize={20} color={"white"}>{number}</Typography>
                </Box>
                <Box flex={1} >
                    <Typography variant={"tituloSessao"}>
                        {description}
