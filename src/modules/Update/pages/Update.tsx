        ...
        >
            ...
            >
                ...
                {updateConfirmed ?
                    <>
                        <Box mt="xxl">
                            <Typography fontFamily="nunitoSemiBold" fontSize={13} textAlign="center">
                                Baixando...
                            </Typography>
                        </Box>
                        <Animatable.View animation="fadeIn" style={{ width: "100%", paddingHorizontal: 60 }}>
                            <ProgressBar
                    ...
                    <>
                        {currentStep !== percentStep ?
                            <>
                                ...
                                <Box>
                                    <Typography fontFamily="nunitoSemiBold" fontSize={13} textAlign="center">
                                        Fizemos correções no app para tornar sua experiência a mais tranquila possível.
                                    </Typography>
                                </Box>
                            </>
                            :
