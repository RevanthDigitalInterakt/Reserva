...
function DiscountCodeModal({ data, isVisible, onClose }: IDiscountCodeModal) {
    ...
    isVisible && (
      <>
        <Box
          ...
          height={37}
          flexDirection="row"
          testID="com.usereserva:id/discount_code_modal_container"
        >
...
export default React.memo(DiscountCodeModal);
