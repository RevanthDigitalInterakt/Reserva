  ...
  var _PricesSelectBoxes = _$$_REQUIRE(_dependencyMap[0])(_$$_REQUIRE(_dependencyMap[6]));
  ...
  function ProductSummary() {
    ...
    var _useProductDetailStor = (0, _$$_REQUIRE(_dependencyMap[9]).useProductDetailStore)(['productDetail', 'selectedSize', 'selectedColor', 'selectedGiftCardSku']),
    ...
    var saleOff = (0, _react.useMemo)(function () {
      if (!productDetail) return null;
      if (productDetail.saleOff && getBoolean('sale_off_tag')) {
        return _icons.default.saleOff;
      }
      return null;
    }, [getBoolean, productDetail]);
    var showPrimeBox = (0, _react.useMemo)(function () {
      return getBoolean('show_price_prime_pdp') && primeActive;
    }, [getBoolean, primeActive]);
    var onClickShare = (0, _react.useCallback)(function () {
      if (!productDetail) return;
      var share = productDetail.share;
      (0, _$$_REQUIRE(_dependencyMap[11]).onShare)(share.title, share.message, share.url);
    ...
    var isGiftCard = (productDetail == null ? undefined : productDetail.action) === _$$_REQUIRE(_dependencyMap[12]).ProductResultActionEnum.ShowGiftCard;
    var ProductDetailCardComponent = (0, _react.useMemo)(function () {
      if (showPrimeBox || isGiftCard) {
        return _$$_REQUIRE(_dependencyMap[13]).NewProductDetailCard;
      }
      return _$$_REQUIRE(_dependencyMap[14]).ProductDetailCardLegacy;
    }, [showPrimeBox]);
    ...
    return /*#__PURE__*/(0, _$$_REQUIRE(_dependencyMap[15]).jsxs)(_$$_REQUIRE(_dependencyMap[15]).Fragment, {
      children: [/*#__PURE__*/(0, _$$_REQUIRE(_dependencyMap[15]).jsx)(_$$_REQUIRE(_dependencyMap[16]).ModalZoomImage, {
      ...
      }), /*#__PURE__*/(0, _$$_REQUIRE(_dependencyMap[15]).jsx)(ProductDetailCardComponent, {
        testID: `com.usereserva:id/productdetail_card_${(0, _$$_REQUIRE(_dependencyMap[17]).slugify)(productDetail.productId)}`,
        ...
        discountTag: (selectedSize == null ? undefined : selectedSize.discountPercent) || 0,
        saleOff: saleOff,
        avaibleUnits: (selectedSize == null ? undefined : selectedSize.availableQuantity) || undefined,
        ...
        fvcProductReference: (productDetail == null ? undefined : productDetail.fvcProductReference) || ''
      }), !!showPrimeBox && !isGiftCard && /*#__PURE__*/(0, _$$_REQUIRE(_dependencyMap[15]).jsx)(_PricesSelectBoxes.default, {
        hasPrime: productDetail == null ? undefined : productDetail.hasPrime,
        selectedSize: selectedSize
      })]
    });
  }
  var _default = exports.default = ProductSummary;
