  ...
  function ProductPricePrimeRow(_ref) {
    var installments = _ref.installments,
      _ref$currency = _ref.currency,
      currency = _ref$currency === undefined ? defaultCurrency : _ref$currency,
    ...
    var container = _reactNative.StyleSheet.flatten([_$$_REQUIRE(_dependencyMap[2]).styles.wrapper, installments ? _$$_REQUIRE(_dependencyMap[2]).styles.start : _$$_REQUIRE(_dependencyMap[2]).styles.between]);
    var flag = _reactNative.StyleSheet.flatten([_$$_REQUIRE(_dependencyMap[2]).styles.containerPrime, installments && _$$_REQUIRE(_dependencyMap[2]).styles.ml]);
    return /*#__PURE__*/(0, _$$_REQUIRE(_dependencyMap[3]).jsx)(_reactNative.View, {
      ...
      children: /*#__PURE__*/(0, _$$_REQUIRE(_dependencyMap[3]).jsxs)(_reactNative.View, {
        ...
        children: [/*#__PURE__*/(0, _$$_REQUIRE(_dependencyMap[3]).jsx)(_reactNative.Text, {
          style: _$$_REQUIRE(_dependencyMap[2]).styles.textPrice,
          children: `${currency} `
        ...
        }), installments && /*#__PURE__*/(0, _$$_REQUIRE(_dependencyMap[3]).jsxs)(_$$_REQUIRE(_dependencyMap[3]).Fragment, {
          children: [/*#__PURE__*/(0, _$$_REQUIRE(_dependencyMap[3]).jsx)(_reactNative.View, {
            style: _$$_REQUIRE(_dependencyMap[2]).styles.divider
          }), /*#__PURE__*/(0, _$$_REQUIRE(_dependencyMap[3]).jsxs)(_reactNative.Text, {
            style: [_$$_REQUIRE(_dependencyMap[2]).styles.textInstallments, {
              fontSize: 12
            }],
          ...
          children: /*#__PURE__*/(0, _$$_REQUIRE(_dependencyMap[3]).jsx)(_reactNative.Text, {
            style: _$$_REQUIRE(_dependencyMap[2]).styles.labelPrime,
            children: "Prime"
          })
        })]
      })
  ...
  var _default = exports.default = ProductPricePrimeRow;
