  ...
  function FilterColors(_ref) {
    ...
    return /*#__PURE__*/(0, _$$_REQUIRE(_dependencyMap[4]).jsxs)(_$$_REQUIRE(_dependencyMap[4]).Fragment, {
      children: [/*#__PURE__*/(0, _$$_REQUIRE(_dependencyMap[4]).jsx)(_TitleFilter.default, {
        ...
        paddingX: "micro",
        children: /*#__PURE__*/(0, _$$_REQUIRE(_dependencyMap[4]).jsx)(_$$_REQUIRE(_dependencyMap[6]).SelectColorFilter, {
          disabledColors: [],
          listColors: showSection ? colors : colors.slice(0, 6),
          onPress: function onPress(color) {
            var newSet = new Set(Array.from(selectedItems));
            if (newSet.has(color)) {
              newSet.delete(color);
            } else {
              newSet.add(color);
  ...
  var _default = exports.default = FilterColors;
